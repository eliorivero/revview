...
class WP_REST_Public_Revisions_Controller extends WP_REST_Controller {
	...
	public function register_routes() {
		...
		register_rest_route( 'wp/v2', '/' . $this->parent_base . '/(?P<parent_id>[\d]+)/revisions/public', array(
			array(
		...
		register_rest_route( 'wp/v2', '/' . $this->parent_base . '/(?P<parent_id>[\d]+)/revisions/public/(?P<revision_id>[\d]+)', array(
			array(
				'methods'         => WP_REST_Server::READABLE,
